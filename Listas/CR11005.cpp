/*MEMORIA DINAMICA: Crear la función MULTIPLO3 la cual recorre una lista doblemente 
enlazada y elimna los elementos de esta que corresponden a los multiplos de 3*/
